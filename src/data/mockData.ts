...
export const mockUsers: User[] = [
  ...
  {
    id: 'user-002',
    email: 'manager@garuda.com',
    name: 'Budi Santoso',
    role: 'travel_agent_admin',
    travelAgentId: 'ta-001',
    travelAgentName: 'Garuda Travel',
    isActive: true,
    createdAt: '2024-01-02T00:00:00Z',
  },
  {
    id: 'user-003',
    email: 'sales@garuda.com',
    name: 'Dewi Lestari',
  ...
  {
    id: 'user-004',
    email: 'manager@sriwijaya.com',
    name: 'Ahmad Wijaya',
    role: 'travel_agent_admin',
    travelAgentId: 'ta-002',
    travelAgentName: 'Sriwijaya Tours',
    isActive: true,
    createdAt: '2024-01-04T00:00:00Z',
  },
  {
    id: 'user-005',
    email: 'sales@sriwijaya.com',
    name: 'Siti Rahayu',
    role: 'travel_agent_user',
    travelAgentId: 'ta-002',
    travelAgentName: 'Sriwijaya Tours',
